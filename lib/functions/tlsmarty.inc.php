...
class TLSmarty extends Smarty {
  ...
  static function getImageSet() {
    ...
    $dummy = array('active' => $imgLoc . 'flag_green.png',
                   'activity' => $imgLoc . '24x24/information.png',
                   'account' => $imgLoc . '24x24/user_edit.png',
                   'add' => $imgLoc . 'add.png',
                   ...
                   'calendar' => $imgLoc . '24x24/calendar.gif',
                   'checked' => $imgLoc . '24x24/apply_f2_16.png',
                   'choiceOn' => $imgLoc . '24x24/accept.png',
                   'clear' => $imgLoc . '24x24/trash.png',
                   'clear_notes' => $imgLoc . 'font_delete.png',
                   'clipboard' => $imgLoc . 'page_copy.png',
                   'check_ok' => $imgLoc . '24x24/lightbulb.png',
                   'check_ko' => $imgLoc . '24x24/warning.png',
                   'cog'  => $imgLoc . '24x24/cog.png',
                   'copy_attachments'  => $imgLoc . 'folder_add.png',
                   'create_copy' => $imgLoc . '24x24/application_double.png',
                   'create_from_xml' => $imgLoc . 'wand.png',
                   'date' => $imgLoc . 'date.png',
                   'delete' => $imgLoc . '24x24/trash.png',
                   ...
                   'direct_link' => $imgLoc . '24x24/world_link.png',
                   'duplicate' => $imgLoc . '24x24/application_double.png',
                   'edit' => $imgLoc . 'icon_edit.png',
                   'edit_icon' => $imgLoc . 'edit_icon.png',
                   'email' => $imgLoc . 'email.png',
                   'events' => $imgLoc . '24x24/bell.png',
                   'eye' => $imgLoc . '24x24/eye.png',
                   'vorsicht' => $imgLoc . 'exclamation.png',
                   'export' => $imgLoc . '24x24/export.png',
                   ...
                   'execution' => $imgLoc . '24x24/administration.png',
                   ...
                   'ghost_item' => $imgLoc . '24x24/ghost.png',
                   'user_group' => $imgLoc . 'group.png',
                   'heads_up' => $imgLoc . '24x24/lightbulb.png',
                   'help' => $imgLoc . 'question.gif',
                   'history' => $imgLoc . '24x24/history.png',
                   'history_small' => $imgLoc . '24x24/history_small.png',
                   'home' => $imgLoc . '24x24/application_home.png',
                   'import' => $imgLoc . '24x24/door_in.png',
                   ...
                   'lock' => $imgLoc . '24x24/lock.png',
                   'lock_open' => $imgLoc . '24x24/lock_open.png',
                   'log_message' => $imgLoc . 'history.png',
                   'log_message_small' => $imgLoc . 'history_small.png',
                   'logout' => $imgLoc . '24x24/logout.png',
                   'magnifier' => $imgLoc . '24x24/magnifier.png',
                   'move_copy' => $imgLoc . '24x24/application_double.png',
                   'new_f2_16' => $imgLoc . 'new_f2_16.png',
                   'note_edit' => $imgLoc . 'note_edit.png',
                   'note_edit_greyed' => $imgLoc . 'note_edit_greyed.png',
                   'on' => $imgLoc . '24x24/lightbulb.png',
                   'off' => $imgLoc . '24x24/lightbulb_off.png',
                   'order_alpha' => $imgLoc . '24x24/style.png',
                   'plugins' => $imgLoc . '24x24/connect.png',
                   'public' => $imgLoc . 'door_open.png',
                   'private' => $imgLoc . 'door.png',
                   'remove' => $imgLoc . 'delete.png',
                   'reorder' => $imgLoc . 'arrow_switch.png',
                   'report' => $imgLoc . '24x24/report.png',
                   'report_word' => $imgLoc . '24x24/page_word.png',
                   'requirements' => $imgLoc . '24x24/cart.png',
                   ...
                   'testcase_execution_type_manual' => $imgLoc . '24x24/user.png',
                   'test_specification' => $imgLoc . '24x24/chart_organisation.png',
                   'toggle_all' => $imgLoc .'24x24/toggle_all.gif',
                   'user' => $imgLoc . '24x24/user.png',
                   'upload' => $imgLoc . 'upload_16.png',
                   'upload_greyed' => $imgLoc . 'upload_16_greyed.png',
                   'warning' => $imgLoc . 'error_triangle.png',
                   'wrench' => $imgLoc . '24x24/wrench.png',
